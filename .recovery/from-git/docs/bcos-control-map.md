...
> **Generated:** 2026-05-06T11:11:45.203952Z by `.claude/scripts/bcos_inventory.py`
>
...
| human-or-llm | 60 | Canonical docs edited by user/AI. |
| mixed | 1 | Mechanical scaffold plus human/AI judgment. |
| llm-instruction | 79 | Skills/agents that guide AI behavior. |
| code | 159 | Executable scripts/hooks. |
| config-or-derived | 35 | Runtime state or editable config. |
...
| docs/_bcos-framework/architecture/wiki-zone.md | framework | - | - | - | 2026-05-06 | no |
...
| docs/_planned/autonomy-ux-self-learning/cross-plan-lifecycle-sweep-additions.md | planned | - | - | - | 2026-05-06 | no |
...
| docs/_planned/wiki-synthesis-pages/README.md | planned | orientation | planned | Framework Evolution | 2026-05-06 | yes |
| docs/_planned/wiki-user-action-scripts/README.md | planned | orientation | planned | Framework Evolution | 2026-05-06 | yes |
...
| wiki-canonical-drift | True | daily | .claude/skills/schedule-dispatcher/references/job-wiki-canonical-drift.md | wiki-canonical-drift-suggestion |
...
| .claude/quality/sessions/20260506_100433_wiki-authority-temporal/plan-manifest.json | completed | agenting | 37 | completed:33, split-deferred:4 |
| docs/_planned/autonomy-ux-self-learning/plan-manifest.json | completed-v1 | agenting | 79 | completed:71, deferred-future:8 |
| docs/_planned/lifecycle-sweep/plan-manifest.json | in-progress-p7-pending | agenting | 46 | completed:41, pending:5 |
