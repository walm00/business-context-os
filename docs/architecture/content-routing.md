...
How new content enters, flows through, and settles into the right location in Business Context OS. This document covers the mechanics -- for the business rationale behind folder zones and ownership, see `docs/architecture/system-design.md`.
