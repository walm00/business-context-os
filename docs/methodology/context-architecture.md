...
Each context data point can be formally specified using six keywords that define its territory, boundaries, and relationships. This format is the core of CLEAR Context OS.
