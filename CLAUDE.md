...
1. **`docs/.onboarding-checklist.md`** — If this file exists, onboarding is incomplete. Mention the next unchecked item once (don't nag). When all items are checked, delete this file and remove this line from CLAUDE.md.
