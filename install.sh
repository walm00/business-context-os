...
echo ""
echo "  Open Claude Code and tell it about your business:"
echo ""
echo "  Starting fresh?"
echo "    \"I want to set up my business context. Here's my website: [url]\""
echo ""
echo "  Already have docs?"
echo "    \"Scan my repo and show me what business context already exists.\""
echo ""
echo "  Full guide: docs/guides/getting-started.md"
echo ""
