...
| Maintenance routine | `/` | 5-dot strip — one dot per BCOS job (`index-health`, `audit-inbox`, `daydream-lessons`, `daydream-deep`, `architecture-review`). Click a dot to open its drawer. |
