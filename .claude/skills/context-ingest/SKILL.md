...
**For all other inputs, ask the user: "What do you want to do with this?"**
...
| "I have a bunch of these" / bulk similar files (call transcripts, reports, invoices) | Route to a collection folder. Keep original filenames. Append entry to collection index if one exists. See `docs/architecture/content-routing.md` Path 5. | `docs/_collections/[type]/` |
